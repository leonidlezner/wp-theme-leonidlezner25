...
<div class="flex items-center space-x-3 justify-center mt-2 text-color3">
  <?php if ($reactions['reply'] > 0) : ?>
    <div class="flex items-center space-x-1">
      ...
      <div><?php echo $reactions['reply']; ?></div>
    </div>
  <?php endif; ?>

  <?php if ($reactions['boost'] > 0) : ?>
    <div class="flex items-center space-x-1">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
      ...
      <div><?php echo $reactions['boost']; ?></div>
    </div>
  <?php endif; ?>
  ...
  <?php if ($reactions['like'] > 0) : ?>
    <div class="flex items-center space-x-1">
      ...
      <div><?php echo $reactions['like']; ?></div>
    </div>
  <?php endif; ?>
</div>