...
<?php if (have_posts()): ?>
  <div class="grid grid-cols-7 gap-7">
    <div class="col-span-7 lg:col-span-5 space-y-[4em]">
      ...
      <?php if (is_search()): ?>
        <h1 class="text-3xl font-heading font-bold mb-12 text-color2"><?php lang(
            "Search results for",
  ...
  <div class="text-center mt-10 py-10 w-1/2 mx-auto border border-color4 rounded-md">
    <div class="text-color2">
      <div class="text-center space-x-2">
        ...
        <div class="text-2xl font-semibold"><?php lang(
            "No posts found",
        ); ?></div>
      </div>
    </div>
    ...
    <div class="mt-5">
      <p class="mb-2"><?php lang(
          "Try to search for some other keywords",
      ); ?></p>
      <form action="<?php echo home_url(
          "/",
      ); ?>" method="get" class="space-y-3 px-10">
        <?php get_template_part("src/form/input", null, [
            "name" => "s",
            "id" => "content-s",
            "value" => get_search_query(),
            "placeholder" => get_lang("Search"),
        ]); ?>
        <?php get_template_part("src/form/button", null, [
            "caption" => get_lang("Search button"),
        ]); ?>
      </form>
    </div>
  </div>
